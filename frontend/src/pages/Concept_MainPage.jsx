...
const ConceptMainPage = () => {
    ...
    // 조건부 중앙 정렬 스타일 정의
    const centerSectionStyle = isLoggedIn ? {
        display: 'flex',    
        alignItems: 'center',     // 수직 중앙 정렬
       flexDirection: 'column', // flex를 사용할 때 자식 요소가 중앙 정렬되도록 column으로 설정
    } : {};
        ...
        <>
            ...
            <div className="login-page-container">
                ...
                <div className="main-content-area">
                    ...
                    {/* 로그인 전후 모두 필요한 Welcome Section */}
                    <section className="welcome-section">
                        <h2 className="main-welcome-title fade-in-text fade-in-delay-1"> 
                            <svg 
                                        width="50" height="50" 
                        ...
                        <h2 className="main-welcome-title fade-in-text fade-in-delay-1">
                            <p>
                            with <span className="glow-k">K</span> - Chat <span className="glow-ai">AI </span>
                        ...
                        <p className="welcome-text fade-in-text fade-in-delay-3">
                            Generate Your Ultimate Korea Schedules in Seconds. <br />
                        </p>
                    </section>

                    {/*
                    **************************************************
                    수정 사항: isLoggedIn 상태에 따라 중앙 정렬 스타일을 적용
                    **************************************************
                    */}
                    <section 
                        className="concept-selection" 
                        style={centerSectionStyle} // 조건부 스타일 적용
                    >

                        {/* 두 요소를 가로로 나란히 정렬 */}
                        {/* 이 div는 centerSectionStyle에 의해 부모 section의 중앙에 위치하게 됩니다. */}
                        <div style={{display: 'flex', alignItems: 'center', gap: '50px'}}>
                            
<MotionLink
    to="/chatbot/demon-hunters" // 챗봇 페이지 경로
    className="vertical-link-wrapper" // 🚨 새 클래스: 수직 정렬을 위한 래퍼
